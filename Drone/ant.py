...
class AntDrone():
  ...
  def checkNorthNeighbor(self, territory):
    if self.positionY == 0:
      ...
      self.northPheromone = territory[self.positionY-1][self.positionX].cellQuality
    return
  ...
  def checkSouthNeighbor(self, territory):
    if self.positionY == len(territory) - 1:
      ...
      self.southPheromone = territory[self.positionY+1][self.positionX].cellQuality
    return
  ...
  def checkEastNeighbor(self, territory):
    if self.positionX == len(territory)-1:
      ...
      self.eastPheromone = territory[self.positionY][self.positionX+1].cellQuality
    return
  ...
  def checkWestNeighbor(self, territory):
    if self.positionX == 0:
      ...
      self.westPheromone = territory[self.positionY][self.positionX-1].cellQuality
    return
